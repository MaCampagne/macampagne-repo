...
function change_message($message, $form){
    return "<p style='color:red; padding-top: 40px; padding-bottom: 20px; font-size: 20px; border-bottom: 2px solid; border-color: red'>Erreur de validation - Veuillez vérifier les champs surlignés. </p>";
}
