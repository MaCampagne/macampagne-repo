	...
	register_field_group(array (
		...
		'fields' => array (
			...
			array (
				...
				'type' => 'number',
				'instructions' => __('As a percentage (%) based on location.<br><br><strong>Left/Right Trigger Location:</strong> If the trigger is located on either the left or right side, this will be the percentage from the top of the window.<br><br><strong>Top/bottom Trigger Location:</strong> If the trigger is located on the top or bottom side, this will be the percentage from the left of the browser window.', 'bne-flyout'),
				'conditional_logic' => array (
					'status' => 1,
					'rules' => array (
						array (
			...
			array (
				...
				'type' => 'text',
				'instructions' => __('This is the text used for the button label. You can also use basic HTML including font icons, such as Font Awesome, if available from your theme or another plugin.', 'bne-flyout'),
				'conditional_logic' => array (
					'status' => 1,
					'rules' => array (
						array (
			...
			array (
				...
				'choices' => array (
					...
					'hide_on_mobile' => __('Hide on Mobile Devices ( 0 < 599px )', 'bne-flyout'),
				),
				'default_value' => '',
				'layout' => 'vertical',
			),
